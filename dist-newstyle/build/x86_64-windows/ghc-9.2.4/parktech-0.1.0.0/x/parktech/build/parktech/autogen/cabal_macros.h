...
/* package parktech-0.1.0.0 */
#ifndef VERSION_parktech
#define VERSION_parktech "0.1.0.0"
#endif /* VERSION_parktech */
#ifndef MIN_VERSION_parktech
#define MIN_VERSION_parktech(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_parktech */
...
#define CURRENT_COMPONENT_ID "parktech-0.1.0.0-inplace-parktech"
